  ...
  return (
    <div className="legal-container">
      <div className="legal-content">
        <h1 style={{ color: '#000' }}>Terms of Service</h1>
        <p className="last-updated">Last updated: August 22, 2025</p>
        
        <section className="legal-section">
          <h2 style={{ color: '#000' }}>1. Introduction</h2>
          <p>
        ...
        <section className="legal-section">
          <h2 style={{ color: '#000' }}>2. Use of Service</h2>
          <p>
        ...
        <section className="legal-section">
          <h2 style={{ color: '#000' }}>3. User Accounts</h2>
          <p>
        ...
        <section className="legal-section">
          <h2 style={{ color: '#000' }}>4. Intellectual Property</h2>
          <p>
        ...
        <section className="legal-section">
          <h2 style={{ color: '#000' }}>5. Limitation of Liability</h2>
          <p>
        ...
        <section className="legal-section">
          <h2 style={{ color: '#000' }}>6. Changes to Terms</h2>
          <p>
